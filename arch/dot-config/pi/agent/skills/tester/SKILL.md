...
Use this skill to run validation commands and report results. It may execute tests, linters, type checks, or reproduction commands, but it should not modify source files or fix failures.
...
- Write summaries or failure reports under `.agents/reviews/`.
